...
var app = new Vue({
  ...
  data: {
    ...
    images: {
      introducao: [
        { id: 0, src: "assets/introducao/1.jpeg" },
        { id: 1, src: "assets/introducao/2.jpeg" },
      ],
      idade_gestacional: [{ id: 0, src: "assets/cardeneta.png" }],
      dilatacao_do_colo_do_utero: [
        { id: 0, src: "assets/dilatacao/1.png" },
        { id: 1, src: "assets/dilatacao/2.png" },
      ],
      sinais_e_sintomas_naturais_esperados: [
      ...
      alteracoes_emocionais_na_mae: [
        ...
        { id: 1, src: "assets/emocoes/1.jpeg" },
        { id: 2, src: "assets/emocoes/2.jpeg" },
      ],
      ajuda_do_acompanhante: [
      ...
      a_mae_deve_se_alimentar_bem: [
        ...
        { id: 1, src: "assets/alimentacao/1.jpeg" },
        { id: 2, src: "assets/alimentacao/2.jpg" },
      ],
      algumas_posicoes_durante_o_trabalho_de_parto: [
      ...
      amamentacao: [
        ...
        { id: 1, src: "assets/amamentacao/1.png" },
      ],
      contato_pele_a_pele: [
        { id: 0, src: "assets/image020.png" },
        { id: 1, src: "assets/contato-pele-a-pele/1.jpg" },
        { id: 2, src: "assets/contato-pele-a-pele/2.png" },
      ],
    },
  },
  mounted() {
